        ...
        return (
            <>
                ...
                <Form className="auth-form" centered onSubmit={(e) => this.handleSubmit(e)}>
                    <Form.Group centered>
                        <Form.Input onChange={(e) => this.handleChange(e)} name="first_name" required={true}
                                    label="First Name" type="text"/>
                        <Form.Input onChange={(e) => this.handleChange(e)} name="last_name" required={true}
                                    label="Last Name" type="text"/>
                    </Form.Group>
                    <Form.Input onChange={(e) => this.handleChange(e)} name="email" required={true} label="Email"
                                type="email"/>
...
export default connect(mapStateToProps, {loginUser, logoutUser})(Signup);